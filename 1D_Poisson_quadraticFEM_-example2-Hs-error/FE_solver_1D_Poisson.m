function solution=FE_solver_1D_Poisson(left,right,h,basis_type_trial,basis_type_test,Gauss_type,norm_type)
...
error=Error_type(norm_type,solution,Pb,P,T,Tb_trial,Gauss_type,basis_type_trial)
