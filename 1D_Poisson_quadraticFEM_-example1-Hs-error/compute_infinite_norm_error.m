function error=compute_infinite_norm_error(ana_sol,solution_vector,P,T,Tb_trial,Gauss_type,basis_type)
...
for n=1:number_of_elements
   ...
   for i=1:Gpn
    ...
    w_ns=local_FE_function_1D(Gauss_nodes(i),uh_local_coefficient_vector,vertices,basis_type,number_of_local_basis_fun,basis_der_x);
     
    ana_sol_vector=feval(ana_sol,Gauss_nodes(i));% value of ith Gauss point of analytic solution in this cell
