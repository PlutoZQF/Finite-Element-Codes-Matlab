function error=compute_infinite_norm_error_2D(ana_sol,solution_vector,P,T,Tb_trial,Gauss_type,basis_type)
...
for n=1:number_of_elements
   ...
   for i=1:Gpn
    ...
    ana_sol_vector=feval(ana_sol,Gauss_nodes(1,i),Gauss_nodes(2,i));% value of ith Gauss point of analytic solution in this cell
